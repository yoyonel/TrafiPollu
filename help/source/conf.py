# -*- coding: utf-8 -*-
#
# interactive_map_tracking documentation build configuration file, created by
...
project = u'interactive_map_tracking'
copyright = u'2013, Lionel Atty, IGN, SIDT'
...
latex_documents = [
  ('index', 'interactive_map_tracking.tex', u'interactive_map_tracking Documentation',
   u'Lionel Atty, IGN, SIDT', 'manual'),
]
